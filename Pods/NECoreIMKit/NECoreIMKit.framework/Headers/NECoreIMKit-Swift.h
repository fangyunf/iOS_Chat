...
/// returns:
/// 好友列表
- (void)getMyFriends:(BOOL)fetch :(NSArray<NIMUser *> * _Nullable)myFriends :(void (^ _Nonnull)(NSArray<NEKitUser *> * _Nullable, NSError * _Nullable))completion;
/// 获取好友列表（废弃）
/// fetch: 是否直接从远端拉取
///
/// returns:
/// 好友列表
- (void)getMyFriends:(BOOL)fetch :(void (^ _Nonnull)(NSArray<NEKitUser *> * _Nullable, NSError * _Nullable))completion;
...
- (void)getUserInfoAdvancedWithUserIds:(NSArray<NSString *> * _Nonnull)userIds :(void (^ _Nonnull)(NSArray<NEKitUser *> * _Nonnull, NSError * _Nullable))completion;
- (void)addFriendWithRequest:(NEAddFriendRequest * _Nonnull)request :(void (^ _Nonnull)(NSError * _Nullable))completion;
/// deleteFiend
...
- (void)updateUser:(NEKitUser * _Nonnull)user :(void (^ _Nonnull)(NSError * _Nullable))completion;
...
- (void)onFriendChangedWithUser:(NEKitUser * _Nonnull)user;
- (void)onUserInfoChangedWithUser:(NEKitUser * _Nonnull)user;
- (void)onBlackListChanged;
@end
...
/// returns:
/// 全局配置选项
- (IMKitConfigCenter * _Nonnull)getConfigCenter SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC11NECoreIMKit17IMKitConfigCenter")
...
/// 是否允许通讯录异步进行远端加载
@property (nonatomic) BOOL contactAsyncLoadEnable;
@end
...
SWIFT_CLASS("_TtC11NECoreIMKit18NEAddFriendRequest")
...
SWIFT_PROTOCOL("_TtP11NECoreIMKit26NECustomAttachmentProtocol_")
...
SWIFT_CLASS("_TtC11NECoreIMKit18NECustomAttachment")
@interface NECustomAttachment : NSObject <NECustomAttachmentProtocol, NIMCustomAttachment>
@property (nonatomic) NSInteger customType;
@property (nonatomic) CGFloat cellHeight;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nullable data;
- (nonnull instancetype)initWithCustomType:(NSInteger)customType cellHeight:(CGFloat)cellHeight data:(NSDictionary<NSString *, id> * _Nullable)data OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)encodeAttachment SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface NECustomAttachment (SWIFT_EXTENSION(NECoreIMKit))
/// 返回自定义消息 attachment
+ (NECustomAttachment * _Nullable)attachmentOfCustomMessageWithMessage:(NIMMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
/// 返回自定义消息 data
+ (NSDictionary<NSString *, id> * _Nullable)dataOfCustomMessageWithMessage:(NIMMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
/// 返回换行消息标题 title
+ (NSString * _Nullable)titleOfRichTextWithMessage:(NIMMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
/// 返回换行消息内容 body
+ (NSString * _Nullable)bodyOfRichTextWithMessage:(NIMMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
/// 返回换行消息外显文案（有标题返回标题 title，没有标题返回内容 body）
+ (NSString * _Nullable)contentOfRichTextWithMessage:(NIMMessage * _Nullable)message SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC11NECoreIMKit25NECustomAttachmentDecoder")
@interface NECustomAttachmentDecoder : NSObject <NIMCustomAttachmentCoding>
- (id <NIMCustomAttachment> _Nullable)decodeAttachment:(NSString * _Nullable)content SWIFT_WARN_UNUSED_RESULT;
/// 解析自定义消息
- (NECustomAttachment * _Nonnull)decodeCustomMessageWithInfo:(NSDictionary<NSString *, id> * _Nonnull)info SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11NECoreIMKit34NEHistoryMessageSearchOptionByTags")
...
SWIFT_CLASS("_TtC11NECoreIMKit9NEKitUser")
@interface NEKitUser : NSObject
...
@property (nonatomic, strong) NEKitUserInfo * _Nullable userInfo;
...
SWIFT_CLASS("_TtC11NECoreIMKit13NEKitUserInfo")
...
SWIFT_CLASS("_TtC11NECoreIMKit14NENotification")
...
@property (nonatomic, strong) NEKitUser * _Nullable userInfo;
@property (nonatomic, strong) NETeam * _Nullable teamInfo;
@property (nonatomic, copy) NSArray<NENotification *> * _Nullable msgList;
- (BOOL)isEqualToNoti:(NENotification * _Nonnull)noti SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC11NECoreIMKit6NETeam")
...
- (NSArray<NENotification *> * _Nonnull)getNotificationListWithLimit:(NSInteger)limit SWIFT_WARN_UNUSED_RESULT;
- (void)getNotificationListWithLimit:(NSInteger)limit completion:(void (^ _Nonnull)(NSArray<NENotification *> * _Nonnull))completion;
...
- (NSArray<NETeam *> * _Nonnull)getTeamList SWIFT_WARN_UNUSED_RESULT;
- (NETeam * _Nullable)teamInfoWithTeamId:(NSString * _Nullable)teamId SWIFT_WARN_UNUSED_RESULT;
- (NETeam * _Nullable)superTeamInfoWithTeamId:(NSString * _Nullable)teamId SWIFT_WARN_UNUSED_RESULT;
/// 获取指定群ID的群信息
/// \param teamIds 群id列表
///
/// \param completion 回调
...
/// returns:
/// 是否是我所在的群
- (BOOL)isMyTeamWithTeamId:(NSString * _Nonnull)teamId SWIFT_WARN_UNUSED_RESULT;
...
/// \param option 查询条件
///
/// \param completion 完成回调，本地缓存的群信息，如果没有返回nil
///
...
///
- (void)addTeamManagers:(NSString * _Nonnull)teamId :(NSArray<NSString *> * _Nonnull)uids :(void (^ _Nonnull)(NSError * _Nullable))completion;
/// 移除群管理员
/// \param teamId 群Id
///
/// \param uids 成员id列表
...
/// \param completion 完成回调，成功返回nil，失败携带error信息
///
- (void)removeTeamManagers:(NSString * _Nonnull)teamId :(NSArray<NSString *> * _Nonnull)uids :(void (^ _Nonnull)(NSError * _Nullable))completion;
/// 移除群成员
/// <ul>
///   <li>
///     Parameters:
...
///   </li>
///   <li>
///     completion: 完成回调，成功返回nil，失败携带error信息
///   </li>
/// </ul>
- (void)removeMembers:(NSString * _Nonnull)teamId :(NSArray<NSString *> * _Nonnull)uids :(void (^ _Nonnull)(NSError * _Nullable))completion;
@end
...
/// returns:
/// 返回自定义用户信息
- (NEKitUser * _Nullable)getUserInfoWithUserId:(NSString * _Nonnull)userId SWIFT_WARN_UNUSED_RESULT;
/// 从云信服务器批量获取用户资料，返回系统类型的用户信息(NIMUser)
/// \param accids 用户id集合
///
/// \param completion 成功回调
///
- (void)fetchUserInfo:(NSArray<NSString *> * _Nonnull)accids :(void (^ _Nonnull)(NSError * _Nullable, NSArray<NEKitUser *> * _Nullable))completion;
/// 修改自己的用户资料
...
/// returns:
/// Blacklist
- (NSArray<NEKitUser *> * _Nonnull)getBlacklist SWIFT_WARN_UNUSED_RESULT;
@end
