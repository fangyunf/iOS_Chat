...
/// returns:
/// 用户信息User（同NIMUser）
- (void)getUserInfo:(NSString * _Nonnull)userId :(void (^ _Nonnull)(NSError * _Nullable, NEKitUser * _Nullable))completion;
/// 获取单个群成员信息
/// \param userId 用户id
///
/// \param teamId 群组id
...
@property (nonatomic, strong) NEKitUser * _Nullable nimUser;
...
SWIFT_CLASS("_TtC9NEChatKit13ChatUserCache")
@interface ChatUserCache : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)onRecieveNotificationWithNotification:(NENotification * _Nonnull)notification;
/// 系统通知数量变更回调
...
- (void)getFriendList:(BOOL)fetch local:(BOOL)local :(void (^ _Nonnull)(NSArray<NEKitUser *> * _Nullable, NSError * _Nullable))completion;
/// 添加好友
...
/// returns:
/// 用户信息User（同NIMUser）
- (void)getUserInfo:(NSString * _Nonnull)userId :(void (^ _Nonnull)(NSError * _Nullable, NSArray<NEKitUser *> * _Nullable))completion;
/// 从远端获取用户信息
/// \param accountList 用户id列表
///
/// \param completion 完成回调
///
- (void)fetchUserInfoWithAccountList:(NSArray<NSString *> * _Nonnull)accountList :(void (^ _Nonnull)(NSArray<NEKitUser *> * _Nullable, NSError * _Nullable))completion;
@end
...
/// returns:
/// 用户信息User（同NIMUser）
- (void)getUserInfoWithUserId:(NSString * _Nonnull)userId :(void (^ _Nonnull)(NEKitUser * _Nullable, NSError * _Nullable))completion;
/// 从远端获取用户信息
/// \param accountList 用户id列表
///
/// \param completion 完成回调
...
///   </li>
///   <li>
///     mapType: 地图页面类型，0 地图详情页，用于查看地址位置消息  1 搜索，用于发送地址位置消息搜索位置
///   </li>
/// </ul>
...
/// @param teamId 群组 ID
/// @return 群组信息
- (NIMTeam * _Nullable)getTeam:(NSString * _Nonnull)teamId SWIFT_WARN_UNUSED_RESULT;
/// 退出群组
/// @param teamId     群组ID
/// @param completion 完成后的回调
...
- (void)removeTeamMember:(NSString * _Nonnull)teamId :(NSArray<NSString *> * _Nonnull)uids :(void (^ _Nonnull)(NSError * _Nullable))completion;
/// 发送创建群聊成功的本地提示消息
/// @param teamId      群组ID
