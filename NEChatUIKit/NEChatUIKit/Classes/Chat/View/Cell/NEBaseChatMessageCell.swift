...
open class NEBaseChatMessageCell: NEChatBaseCell {
  ...
  public var avatarImageLeft = UIImageView() // 左侧头像
    public var avatarFrameLeft = UIImageView() // 左侧头像框
  ...
  public var avatarImageRight = UIImageView() // 右侧头像
    public var avatarFrameRight = UIImageView() // 右侧头像框
  ...
  public var timeLabel = UILabel() // 消息时间
    public var tagLeftLabel = UILabel() // 消息时间
    public var tagRightLabel = UILabel() // 消息时间
...
//    timeLabel.backgroundColor = HexRGB(0x999999)

      
    // avatar
      avatarImageLeft.backgroundColor = .white
    ...
    avatarImageLeft.accessibilityIdentifier = "id.avatar"
      ...
      avatarFrameLeft.contentMode = .scaleAspectFill
            avatarFrameLeft.clipsToBounds = true
            avatarFrameLeft.accessibilityIdentifier = "id.frame"
      
      tagLeftLabel.font = .systemFont(ofSize: 11)
      tagLeftLabel.textColor = .white
      tagLeftLabel.textAlignment = .center
      tagLeftLabel.layer.cornerRadius = 5
      tagLeftLabel.layer.masksToBounds = true
      tagLeftLabel.isHidden = true
      tagLeftLabel.translatesAutoresizingMaskIntoConstraints = false
      tagLeftLabel.backgroundColor = UIColor(hexString: "#FC6930")

      avatarImageRight.backgroundColor = UIColor.white
    ...
    avatarImageRight.accessibilityIdentifier = "id.avatar"
      ...
      avatarFrameRight.contentMode = .scaleAspectFill
            avatarFrameRight.clipsToBounds = true
            avatarFrameRight.accessibilityIdentifier = "id.frame"

      tagRightLabel.font = .systemFont(ofSize: 11)
      tagRightLabel.textColor = .white
      tagRightLabel.textAlignment = .center
      tagRightLabel.layer.cornerRadius = 5
      tagRightLabel.layer.masksToBounds = true
      tagRightLabel.isHidden = true
      tagRightLabel.translatesAutoresizingMaskIntoConstraints = false
      tagRightLabel.backgroundColor = UIColor(hexString: "#FC6930")
    // name
  ...
  open func baseCommonUI() {
    ...
    NSLayoutConstraint.activate([
      ...
      timeLabel.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: (kScreenWidth - 200)/2),
      timeLabel.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -(kScreenWidth - 200)/2),
  ...
  open func baseCommonUILeft() {
    ...
    NSLayoutConstraint.activate([
      ...
      avatarImageLeft.widthAnchor.constraint(equalToConstant: 46),
      avatarImageLeft.heightAnchor.constraint(equalToConstant: 46),
    ])
      
      contentView.addSubview(avatarFrameLeft)
      avatarFrameLeft.frame = CGRectMake(16, 24, 46, 46)
    ...
    NSLayoutConstraint.activate([
      ...
      NSLayoutConstraint.activate([
        tagLeftLabel.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: chat_content_margin),
        tagLeftLabel.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 16),
        tagLeftLabel.widthAnchor.constraint(equalToConstant: 46),
        tagLeftLabel.heightAnchor.constraint(equalToConstant: 14),
      ])
  }
  ...
  open func baseCommonUIRight() {
    ...
    NSLayoutConstraint.activate([
      ...
      avatarImageRight.widthAnchor.constraint(equalToConstant: 46),
      avatarImageRight.heightAnchor.constraint(equalToConstant: 46),
      avatarImageRight.topAnchor.constraint(equalTo: avatarImageLeft.topAnchor, constant: 0),
    ])
      
      contentView.addSubview(avatarFrameRight)
           avatarFrameRight.frame = CGRectMake(kScreenWidth - 62, 16, 46, 46)
      
      contentView.addSubview(tagRightLabel)
      NSLayoutConstraint.activate([
        tagRightLabel.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: chat_content_margin),
        avatarImageLeftAnchor!,
        tagRightLabel.widthAnchor.constraint(equalToConstant: 46),
        tagRightLabel.heightAnchor.constraint(equalToConstant: 14),
      ])
  ...
  override open func setModel(_ model: MessageContentModel, _ isSend: Bool) {
    ...
    if let time = model.timeContent, !time.isEmpty {
      ...
      timeLabel.isHidden = false
        avatarFrameLeft.frame = CGRectMake(16, 24, 46, 46)
                avatarFrameRight.frame = CGRectMake(kScreenWidth - 62, 24, 46, 46)
    } else {
      timeLabelHeightAnchor?.constant = 0
      timeLabel.text = ""
      timeLabel.isHidden = true
        avatarFrameLeft.frame = CGRectMake(16, 10, 46, 46)
                avatarFrameRight.frame = CGRectMake(kScreenWidth - 62, 10, 46, 46)
    }
    ...
    if let avatarURL = model.avatar, !avatarURL.isEmpty {
        if avatarString != avatarURL {
            let cacheImage = SDImageCache.shared.imageFromDiskCache(forKey: URL(string: avatarURL)?.absoluteString)
            avatarImage.sd_setImage(with: URL(string: avatarURL), placeholderImage: cacheImage) { image, error, type, url in
                if image != nil {
                  avatarImage.image = image
                  nameLabel.isHidden = true
                  avatarImage.backgroundColor = .clear
                } else {
                avatarImage.image = (cacheImage != nil) ? cacheImage:UIImage(named: "avatar_person")
                  nameLabel.isHidden = true
                  avatarImage.backgroundColor = .clear
                }
            }
...
//            avatarImage.backgroundColor = .clear
//          } else {
//            avatarImage.image = UIImage(named: "avatar_person")
//            nameLabel.isHidden = true
//            avatarImage.backgroundColor = UIColor
//              .colorWithString(string: "")
//          }
//        }
    } else {
      avatarImage.image = UIImage(named: "avatar_person")
...
//      readView.isHidden = true
  ...
  open func showLeftOrRight(showRight: Bool) {
    avatarImageLeft.isHidden = showRight
      avatarFrameLeft.isHidden = showRight
    ...
    avatarImageRight.isHidden = !showRight
      avatarFrameRight.isHidden = !showRight
