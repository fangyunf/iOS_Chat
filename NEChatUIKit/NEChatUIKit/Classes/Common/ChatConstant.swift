...
/// 屏幕间隔
public let kScreenInterval: CGFloat = 15
public let NEMoreView_Section_Padding: CGFloat = 32

// 更多操作view
public let NEMoreCell_ReuseId: String = "NEMoreCell"
public let NEMoreCell_Image_Size: CGSize = .init(width: 44.0, height: 44.0)
public let NEMoreCell_Title_Height: CGFloat = 20.0
public let NEMoreView_Margin: CGFloat = 18.0
...
let TextNormalColor: UIColor = HexRGB(0x000000)
